...
func NewKimiAuthWithProxyURL(cfg *config.Config, proxyURL string) *KimiAuth {
	return NewKimiAuthWithDomainAndProxyURL(cfg, KimiDefaultDomain, proxyURL)
}

// NewKimiAuthWithDomainAndProxyURL creates a new KimiAuth service instance for the
// specified domain with a proxy override.
func NewKimiAuthWithDomainAndProxyURL(cfg *config.Config, domain string, proxyURL string) *KimiAuth {
